...
cp -a /etc/pki/ca-trust/extracted/pem/tls-ca-bundle.pem /etc/pki/ca-trust/extracted/pem/tls-ca-bundle.pem.cyp
...
swapoff -a    # https://serverfault.com/questions/684771/best-way-to-disable-swap-in-linux
kubeadm init
